...
import { Megaphone, Plus, Users, CheckCircle2 } from "lucide-react";
          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              {isLoading ? (
                ...
                <tr>
                  <td colSpan={5} className="p-10 text-center text-ink-4">
                ...
                announcements.map((a: any) => (
                  <tr
                    key={a.id}
                    className="border-b border-rule last:border-0 v3-row"
                  >
